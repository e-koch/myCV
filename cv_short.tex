...
\section*{Teaching}
\begin{datelist}
\item[2014-2018] \emph{University of Alberta} \\ ``Teaching Assistant for Physics and Astronomy labs''
\item[2011-2013] \emph{University of British Columbia, Okanagan} \\ ``Teaching Assistant for first and second year physics labs''
\end{datelist}
